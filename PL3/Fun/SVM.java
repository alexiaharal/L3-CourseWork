...
public class SVM {
	...
	public static final byte        // statuses
	   RUNNING = 0,
	   HALTED  = 1,
	   FAILED  = 2;
	...
	// Interpret the program starting at offset 0 in the 
	// code store. If tracing is true, print each instruction 
	// as it is executed.
		data = new int[32768];
		pc = 0;
		sp = 0;
	...
	// Execute a call to an IO routine (read or write).
		switch (c) {
			case READOFFSET: {
				out.print("? ");
				int w = in.nextInt();
