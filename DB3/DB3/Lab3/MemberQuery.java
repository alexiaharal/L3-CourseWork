...
class MemberQuery {
	...
	= "SELECT Member.mid, Member.name as \"Name\", Memberof.instrument FROM Memberof, Member, Band WHERE Memberof.endyear is null AND Memberof.bid=Band.bid AND Member.mid=Memberof.mid AND Band.bid= ";
	/*
